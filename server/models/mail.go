...
func AddMail(m *Mail) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetMailById retrieves Mail by Id. Returns error if
// Id doesn't exist
func GetMailById(id int) (v *Mail, err error) {
	o := orm.NewOrm()
	v = &Mail{Id: id}
...
func UpdateMailById(m *Mail) (err error) {
	o := orm.NewOrm()
	v := Mail{Id: m.Id}
...
// DeleteMail deletes Mail by Id and returns error if
// the record to be deleted doesn't exist
func DeleteMail(id int) (err error) {
	o := orm.NewOrm()
	v := Mail{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&Mail{Id: id}); err == nil {
