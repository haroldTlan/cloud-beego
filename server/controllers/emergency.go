...
// EmergencyController operations for Emergency
type EmergencyController struct {
	beego.Controller
}

// URLMapping ...
func (c *EmergencyController) URLMapping() {
...
// @Param	body		body 	models.Emergency	true		"body for Emergency content"
// @Success 201 {int} models.Emergency
...
// @Success 200 {object} models.Emergency
...
// @Failure 403
// @router / [get]
func (c *EmergencyController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// Put ...
// @Title Put
// @Description update the Emergency
...
// Delete ...
// @Title Delete
// @Description delete the Emergency
