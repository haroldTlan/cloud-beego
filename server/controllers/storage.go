...
// StorageController operations for Storage
...
// @Param	body		body 	models.Storage	true		"body for Storage content"
// @Success 201 {int} models.Storage
// @Failure 403 body is empty
// @router / [post]
func (c *StorageController) Post() {
	var v models.Storage
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddStorage(&v); err == nil {
...
// @router /:id [get]
func (c *StorageController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetStorageById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
// @Failure 403
// @router / [get]
func (c *StorageController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllStorage(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *StorageController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteStorage(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
