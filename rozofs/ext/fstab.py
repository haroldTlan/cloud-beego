...
class Line(object):
    ...
    def is_rozofs_type(self):
        """Does this line have a filesystem specification?"""
        return self.device is not None and self.fstype == self.__ROZOFSTYPE
...
class Fstab(object):
    ...
    def get_rozofs_lines(self):
        return [l for l in self.lines if l.is_rozofs_type()]
